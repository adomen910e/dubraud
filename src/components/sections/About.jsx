      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Sur un domaine de 50 hectares de prairies vallonnées et conduites en rotation (1,5 hectare en moyenne par cheval sur l'année), nous cultivons nous-mêmes, en agriculture biologique, le foin et l'enrubanné de nos pensionnaires. Grâce à nos installations modernes et notre équipe expérimentée, nous garantissons le bien-être de vos chevaux tout en vous proposant un hébergement de qualité dans un cadre bucolique.
            </motion.p>
